...
namespace SpeakTogether.Service.Interface
{
    ...
    {
        public Task<User> CreateUser(string Name, string Email, string PasswordHash, DateTime RegistrationDate);
        public Task <string> LoginAsync(string email, string password);
        public User SoftDelete(int Id);
        public Task<bool> Verify(string email, string password);
